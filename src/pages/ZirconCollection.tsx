        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-3xl mx-auto mb-8">
            <div className="flex items-center justify-center gap-2 bg-blue-50 rounded-lg px-3 py-2.5 border border-blue-200">
              ...
              <span className="text-sm font-medium">Exceptional Fire</span>
            </div>
            <div className="flex items-center justify-center gap-2 bg-blue-50 rounded-lg px-3 py-2.5 border border-blue-200">
              <Gem className="w-4 h-4 text-blue-600" />
              <span className="text-sm font-medium">High Brilliance</span>
            </div>
            <div className="flex items-center justify-center gap-2 bg-blue-50 rounded-lg px-3 py-2.5 border border-blue-200">
              <TrendingUp className="w-4 h-4 text-blue-600" />
              <span className="text-sm font-medium">Prosperity Stone</span>
            </div>
            <div className="flex items-center justify-center gap-2 bg-blue-50 rounded-lg px-3 py-2.5 border border-blue-200">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 mb-8">
            <div className="flex items-center gap-2">
              <div className="flex -space-x-2">
                {['Z', 'I', 'R', 'C', 'N'].map((letter, i) => (
                  <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 border-2 border-white flex items-center justify-center text-xs text-white font-bold">
                    {letter}
                  </div>
                ))}
              </div>
              <span className="text-sm text-muted-foreground">
                <span className="font-bold text-foreground">2,800+</span> Happy Customers
              </span>
            </div>
            <div className="flex items-center gap-1">
              ...
              <span className="text-sm text-muted-foreground">(310+ reviews)</span>
            </div>
