...
const ThemeRoyal = () => {
  ...
  return (
    <div
      ...
      style={{
        // Royal Purple & Gold Theme - Mystical & Premium
        ...
        '--border': '280 20% 88%',
        '--ring': '270 70% 50%',
        '--gradient-hero': 'linear-gradient(135deg, hsl(280 40% 96%), hsl(270 30% 92%))',
        '--gradient-primary': 'linear-gradient(135deg, hsl(270 70% 50%), hsl(270 60% 60%))',
        '--shadow-primary': '0 8px 25px -5px hsl(270 70% 50% / 0.35)',
      } as React.CSSProperties}
    >
      <main className="min-h-screen">
        {/* Theme Info Banner */}
        <div className="bg-primary text-primary-foreground py-3 text-center">
          <p className="text-sm font-medium">🎨 Royal Purple & Gold - Mystical & Premium Theme | <a href="/" className="underline">View Original</a> | <a href="/theme-emerald" className="underline">Emerald</a> | <a href="/theme-sapphire" className="underline">Sapphire</a></p>
        </div>
          ...
          {slides.map((slide, index) => (
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `linear-gradient(rgba(88,28,135,0.6), rgba(59,7,100,0.7)), url(${slide.image})`
                }}
              />
              <div className="relative container h-full flex items-center justify-center text-center text-white px-4">
                <div className="max-w-4xl">
                  ...
                  <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-yellow-300 via-amber-400 to-yellow-500 bg-clip-text text-transparent leading-tight">
                    {slide.subtitle}
                  </h1>
