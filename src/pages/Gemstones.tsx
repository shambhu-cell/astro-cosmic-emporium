...
const Gemstones = () => {
  ...
  const gemstones = [
    ...
    },
    {
      ...
      category: "Semi-Precious",
      planet: "Mercury",
      benefits: ["Luck", "Creativity", "Balance"],
      certified: true,
      weight: "2-4 Carat",
      origin: "Russian"
    },
    {
      ...
      price: 6999,
      originalPrice: 9999,
      image: "https://images.unsplash.com/photo-1583937443566-b7a1e6083b55?w=400&h=400&fit=crop",
      rating: 4.7,
      reviews: 156,
      category: "Semi-Precious",
      planet: "Saturn",
      benefits: ["Communication", "Courage", "Peace"],
      certified: true,
      weight: "5-8 Carat",
      origin: "Brazilian"
    },
    {
      ...
      category: "Semi-Precious",
      planet: "Mercury",
      benefits: ["Prosperity", "Health", "Growth"],
      certified: true,
      weight: "5-7 Carat",
      origin: "Pakistan"
    },
    {
      ...
      category: "Semi-Precious",
      planet: "Venus",
      benefits: ["Healing", "Protection", "Harmony"],
      certified: true,
      weight: "4-6 Carat",
      origin: "Brazilian"
    },
    {
      ...
      category: "Semi-Precious",
      planet: "Venus",
      benefits: ["Creativity", "Love", "Passion"],
      certified: true,
      weight: "5-8 Carat",
      origin: "Australian"
    },
    {
      id: 14,
      name: "Amethyst (Jamuniya)",
      price: 3499,
      originalPrice: 5499,
      image: "https://images.unsplash.com/photo-1588856239109-570b6ac1e3b9?w=400&h=400&fit=crop",
      rating: 4.6,
      reviews: 167,
      category: "Semi-Precious",
      planet: "Saturn",
      benefits: ["Spiritual", "Clarity", "Protection"],
      certified: true,
      weight: "6-8 Carat",
      origin: "Brazilian"
    },
    {
      ...
      category: "Semi-Precious",
      planet: "Jupiter",
      benefits: ["Abundance", "Confidence", "Success"],
      certified: true,
      weight: "5-8 Carat",
      origin: "Brazilian"
    },
    {
      ...
      category: "Semi-Precious",
      planet: "Mars",
      benefits: ["Energy", "Passion", "Vitality"],
      certified: true,
      weight: "5-7 Carat",
      origin: "Indian"
    },
    {
      ...
      category: "Semi-Precious",
      planet: "Jupiter",
      benefits: ["Wisdom", "Fortune", "Health"],
      certified: true,
      weight: "5-8 Carat",
      origin: "Brazilian"
    },
    {
      ...
      category: "Semi-Precious",
      planet: "Jupiter",
      benefits: ["Protection", "Healing", "Luck"],
      certified: true,
      weight: "6-8 Carat",
      origin: "Iranian"
    },
    {
      ...
      category: "Semi-Precious",
      planet: "Saturn",
      benefits: ["Spiritual", "Intuition", "Transformation"],
      certified: true,
      weight: "3-5 Carat",
      origin: "Tanzanian"
    },
    {
      ...
      category: "Semi-Precious",
      planet: "Venus",
      benefits: ["Love", "Compassion", "Peace"],
      certified: true,
      weight: "4-6 Carat",
      origin: "Madagascar"
    },
    {
      ...
      category: "Semi-Precious",
      planet: "Sun",
      benefits: ["Vitality", "Energy", "Strength"],
      certified: true,
      weight: "3-5 Carat",
      origin: "Burmese"
    }
