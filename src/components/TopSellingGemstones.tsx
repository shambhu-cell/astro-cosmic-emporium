            ...
            <CarouselContent className="-ml-2">
              {products.map((product, index) => (
                <CarouselItem key={index} className="pl-2 basis-[85%]">
                  <Card 
                    className="group relative overflow-hidden bg-gradient-to-br from-violet-50 to-background border-2 border-dashed border-violet-400 hover:border-violet-500 hover:shadow-xl transition-all duration-300"
                  >
